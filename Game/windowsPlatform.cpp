...
int  WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR     lpCmdLine, int       nShowCmd)
{
	...
	window_class.lpszClassName = L"Game Windows";
	...
	//Create Window
	HWND window = CreateWindow(window_class.lpszClassName, L"Speed Pong", WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT, 1920, 1080, 0, 0, hInstance, 0);
...
input.buttons[b].is_down = is_down;\
					...
					switch (vk_code) {
						...
						proccess_button(BUTTON_W, 0x57);
							proccess_button(BUTTON_S, 0x53);
